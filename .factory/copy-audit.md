...
| Record team members, services, shared resources, and service-pair rules. | 8 | Pass — `capacity-setup` |
| Choose a time. | 3 | Pass |
| See which jobs fit before changing your calendar. | 8 | Pass — `availability-check` |
| Read the reason. | 3 | Pass |
| Each blocked slot names the team member, shared resource, or service-pair rule. | 12 | Pass — `conflict-explanation` |
...
| The planner records team members, services, shared resources, and service-pair rules. | 10 | Pass — `capacity-setup` |
...
| The demo loads two team members, three services, two shared resources, and three jobs. | 14 | Pass — `demo-isolation` |
...
| Features | 1 | Pass |
| Check team-member, shared-resource, and service-pair conflicts with a plain explanation. | 9 | Pass — `conflict-explanation` |
...
| There are no analytics, third-party fonts, or third-party scripts. | 9 | Pass — `privacy-local-only` (same-origin resource assertions) |
| License | 1 | Pass |
| MIT. | 1 | Pass |
